...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/nur-fitriana-shalihah-bbbb1b251/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@nrftr_s",
    icon: Instagram,
    url: "https://www.instagram.com/nrftr_s/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@nurfitrianashalihah1964",
    icon: Youtube,
    url: "https://www.youtube.com/@nurfitrianashalihah1964",
    color: "#FF0000",
