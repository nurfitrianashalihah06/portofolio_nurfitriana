...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Crafting Intuitive Interfaces & Robust Code
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
...
const StatCard = memo(({ icon: Icon, color, value, label, description, animation }) => (
  <div data-aos={animation} data-aos-duration={1300} className="relative group">
    <div className="relative z-10 bg-white/50 backdrop-blur-lg rounded-2xl p-6 border border-purple-200 overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl h-full flex flex-col justify-between">
      <div className={`absolute -z-10 inset-0 bg-gradient-to-br ${color} opacity-10 group-hover:opacity-20 transition-opacity duration-300`}></div>
      
      <div className="flex items-center justify-between mb-4">
        <div className="w-16 h-16 rounded-full flex items-center justify-center bg-purple-100 transition-transform group-hover:rotate-6">
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Fresh Graduate Teknik Informatika yang antusias dalam menggabungkan estetika desain (UI/UX) dengan kehandalan kode (Web Development). 
              Saya percaya bahwa aplikasi hebat tidak hanya harus berjalan lancar, tetapi juga harus memberikan pengalaman pengguna yang menyenangkan dan intuitif. Berpengalaman dalam merancang user flow dan mengimplementasikannya menjadi website fungsional menggunakan teknologi modern.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Tindakan sering kali memunculkan motivasi."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/uc?export=download&id=1fIHhV9eGRj28OSpNFlDT1VuHcQ2hXeIJ" className="w-full lg:w-auto" target="_blank" rel="noopener noreferrer">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
